  ...
  Widget build(BuildContext context) {
    ...
    bool _restConfModel =
        Get.find<SplashController>().configModel.orderConfirmationModel !=
            'deliveryman';
    bool _showBottomView = orderModel.orderStatus == 'accepted' ||
        orderModel.orderStatus == 'confirmed' ||
        orderModel.orderStatus == 'processing' ||
        orderModel.orderStatus == 'handover' ||
        orderModel.orderStatus == 'picked_up' ||
        isRunningOrder;
    bool _showSlider = (orderModel.paymentMethod == 'cash_on_delivery' &&
              ...
              ? Column(children: [
                  Expanded(
                    ...
                    child: Column(children: [
                      DateConverter.isBeforeTime(orderModel.scheduleAt!)
                          ? (orderModel.orderStatus != 'delivered' &&
                              ...
                              ? Column(children: [
                                  ...
                                  Text('your_food_will_be_delivered_within'.tr,
                      ...
                      InfoCard(
                        ...
                        image: orderModel.customer != null
                            ? '${Get.find<SplashController>().configModel.baseUrls!.customerImageUrl}/${orderModel.customer!.image}'
                            : '',
                        name: orderModel.deliveryAddress!.contactPersonName!,
                        phone: orderModel.deliveryAddress!.contactPersonNumber!,
                        latitude: orderModel.deliveryAddress!.latitude!,
                        longitude: orderModel.deliveryAddress!.longitude!,
                        showButton: orderModel.orderStatus != 'delivered',
                      ),
                      SizedBox(height: Dimensions.PADDING_SIZE_LARGE),
                      Column(
